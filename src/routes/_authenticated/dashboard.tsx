            ...
            <GlassCard key={track}>
              ...
              {open ? (
                <div className="mt-4">
                  ...
                  <Link
                    to={open.slot === 1 && track === "tech" ? "/tech1" : open.slot === 2 && track === "tech" ? "/tech2" : open.slot === 1 && track === "nontech" ? "/nontech1" : open.slot === 2 && track === "nontech" ? "/nontech2" : "/events/$track/$slot"}
                    params={(open.slot === 1 && track === "tech") || (open.slot === 2 && track === "tech") || (open.slot === 1 && track === "nontech") || (open.slot === 2 && track === "nontech") ? undefined : { track, slot: String(open.slot) }}

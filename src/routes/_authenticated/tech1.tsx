    ...
    return (
      <div className="mx-auto max-w-3xl space-y-6">
        <GlassCard>
          ...
          <div className="mt-4 rounded-md bg-white/5 p-4 font-mono text-sm text-white/80">{submission.answer}</div>
    ...
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <GlassCard>
        ...
        <div className="mt-3 flex items-center justify-between">
          <div className="text-xs text-white/50">⚠ One submission only. Cannot be edited.</div>
          <button
